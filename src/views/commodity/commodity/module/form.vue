<template>
  <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '添加商品' : '编辑商品'" width="900px">
    <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="100px">
      <el-form-item label="商品标题" prop="mainTitle">
        <el-input v-model="form.mainTitle" style="width: 270px;"/>
      </el-form-item>
      <el-form-item label="商品副标题" prop="subTitle">
        <el-input v-model="form.subTitle" style="width: 270px;"/>
      </el-form-item>
      <el-form-item label="淘宝链接" prop="taobaoUrl">
        <el-input v-model="form.taobaoUrl" style="width: 270px;"/>
      </el-form-item>
      <el-form-item label="库存" prop="inventory">
        <el-input-number v-model.number="form.inventory" :min="0" :max="9999" controls-position="right" style="width: 270px;"/>
      </el-form-item>
      <el-form-item label="原价" prop="oldPrice">
        <el-input v-model="form.oldPrice" style="width: 270px;"/>
      </el-form-item>
      ...
      <el-form-item label="推荐商品" prop="recommend" style="width: 370px;">
        <el-radio-group v-model="form.recommend">
          ...
          <el-radio label="0">不推</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="热门商品" prop="hot">
